...
const PublishersPage = () => {
    return (
        <motion.div
            className="flex flex-col items-center min-h-screen my-20"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            >
                {/* Hero Section */}
                <div
                    className="relative flex items-center justify-center h-[60vh] w-full bg-cover bg-center rounded-md shadow-lg"
                    style={{
                ...
                <div className="w-full mt-16 mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mt-8 justify-center">
                        {[
                            ...
                            <motion.div
                                key={index}
                                className="relative flex items-center justify-center p-6 bg-cover bg-center text-white rounded-md shadow-lg transition-all duration-300 group h-72 w-96 mx-auto"
                                style={{
