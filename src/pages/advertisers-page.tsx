...
const AdvertisersPage = () => {
    return (
        <motion.div
            ...
            className="flex items-center flex-col min-h-screen my-20 px-4 sm:px-8"
        >
            <motion.div
                initial={{ y: -100 }}
                animate={{ y: 0 }}
                transition={{ duration: 1 }}
                className="flex flex-col items-center justify-center bg-gradient-to-r from-neutral-900/70 to-zinc-900/70 text-zinc-50 rounded-md px-8 pt-10 pb-10 w-full gap-28"
            >
                <div
                ...
                >
                    ...
                    <div className="relative z-10 text-center px-4">
                        <h2 className="text-3xl sm:text-5xl font-bold tracking-normal font-montserrat text-zinc-50 shadow-lg">
                            Why Choose{" "}
                        ...
                        <p className="text-lg sm:text-xl font-montserrat text-zinc-200 mt-6 leading-8 mx-auto w-full sm:w-2/3">
                        ...
                        <button className="mt-6 text-lg sm:text-xl py-2 px-10 text-zinc-50 font-montserrat bg-blue-500 hover:bg-blue-600 transition-all duration-150 rounded-sm tracking-tight shadow-md shadow-slate-800 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50 ease-out">
                ...
                <div className="flex flex-col w-full items-start">
                    <h2 className="text-3xl sm:text-5xl font-bold tracking-normal font-raleway shadow-lg">
                        How It Works
                    </h2>
                    <hr className="h-1 w-3/4 bg-blue-500 my-4 border-0" />
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-16 w-full justify-items-center">
                        {[
                            {
                                icon: IoPeopleSharp,
                                title: "Register",
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    ...
                                    <h3 className="text-xl sm:text-3xl font-bold font-raleway text-white">
                                        {card.title}
                                    </h3>
                                    <p className="text-sm sm:text-base font-montserrat leading-6 text-white">
                                        {card.text}
                                    </p>
                                </div>
                            </motion.div>
                ...
                >
                    <div className="absolute inset-0 bg-neutral-900/70"></div>
                    <div className="relative z-10 text-center px-4">
                        <h1 className="text-4xl sm:text-7xl font-bold tracking-tight font-raleway text-zinc-50 leading-tight">
                            Unlock Your{" "}
