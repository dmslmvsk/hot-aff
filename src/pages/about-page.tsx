...
const AboutPage = () => {
    return (
        <motion.div
            ...
            className="flex items-center flex-col min-h-screen my-20 px-4 sm:px-10"
        >
            <motion.div
                initial={{ y: -100 }}
                animate={{ y: 0 }}
                transition={{ duration: 1 }}
                className="flex flex-col items-center justify-center bg-gradient-to-r from-neutral-900/70 to-zinc-900/70 text-zinc-50 rounded-md px-10 pt-10 pb-10 w-full sm:w-11/12 gap-28"
            >
                <div className="flex flex-col items-center gap-16 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight font-raleway text-center sm:text-left">
                            Loyalty
                            <br />
                            <span className="text-blue-500">fuels</span>
                            <IoFlashOutline className="inline-block w-12 sm:w-16" />
                            <br />
                            success
                        </h1>
                    </div>
                    <div className="w-full sm:w-1/2">
                        <p className="tracking-tight font-montserrat text-xl leading-8 sm:w-11/12 text-center sm:text-left">
                            <span className="text-3xl font-bold">
                                <span className="text-blue-500">Hot</span>
                                Aff
                            </span>{" "}
                            is a young and ambitious company that is reshaping
                            the digital advertising landscape. Guided by loyalty
                            and innovation, we are dedicated to achieving
                            success for advertisers and publishers alike through
                            cutting-edge solutions and seamless collaboration.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start w-full">
                    ...
                    <div className="flex flex-col gap-16 mt-16">
                        <div className="flex flex-col sm:flex-row justify-between items-start">
                            <p className="tracking-tight font-montserrat text-lg leading-8 sm:w-7/12">
                            ...
                            <img
                                ...
                                className="rounded-md shadow-lg w-full sm:w-96"
                            />
                        </div>
                        <div className="flex flex-col sm:flex-row justify-between items-start">
                            <p className="tracking-tight font-montserrat text-lg leading-8 sm:w-7/12">
                ...
                <div className="flex flex-col w-full items-center mt-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center mt-8">
                        <div className="flex flex-col items-center text-center gap-4">
                            <IoHeartSharp className="text-blue-500 text-5xl sm:text-6xl" />
                        ...
                        <div className="flex flex-col items-center text-center gap-4">
                            <IoTimeSharp className="text-blue-500 text-5xl sm:text-6xl" />
                            <h3 className="text-xl font-bold font-raleway">
                                Timely Payments
                            </h3>
                            <p className="text-sm font-montserrat leading-6">
                        ...
                        <div className="flex flex-col items-center text-center gap-4">
                            <IoShieldCheckmarkSharp className="text-blue-500 text-5xl sm:text-6xl" />
                            <h3 className="text-xl font-bold font-raleway">
                                Dependability
                            </h3>
                            <p className="text-sm font-montserrat leading-6">
                        ...
                        <div className="flex flex-col items-center text-center gap-4">
                            <IoPeopleSharp className="text-blue-500 text-5xl sm:text-6xl" />
                            <h3 className="text-xl font-bold font-raleway">
                                Collaboration
                            </h3>
                            <p className="text-sm font-montserrat leading-6">
